...
public class TestDataReaderProperties {
  ...
  private Supplier<FileSystem> mockSupplier = mock(Supplier.class);
  ...
  public void testCompleteBuild() {
    ...
    DataReaderProperties properties = DataReaderProperties.builder()
      .withFileSystemSupplier(mockSupplier)
      .withPath(mockedPath)
      .withCompression(options)
      .withZeroCopy(mockedZeroCopy)
      .build();
    assertEquals(mockSupplier, properties.getFileSystemSupplier());
